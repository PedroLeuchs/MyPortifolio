...
const AboutPage: React.FC<ProjectsPageProps> = ({ section, indexImg }) => {
  ...
  return (
    <section
      ...
      className="scroll-mt-[9vh] mt-[9vh] lg:h-[91vh] min-h-[91vh] h-auto w-full flex-col flex items-center justify-center text-white text-3xl font-bold transition-all duration-700 ease-in-out transform "
    >
      <img
